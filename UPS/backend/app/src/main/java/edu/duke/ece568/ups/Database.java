...
public class Database {
    ...
    public void initDB(){
        ...
        String query2 = "CREATE TABLE PACKAGE(PACKAGE_ID BIGINT PRIMARY KEY NOT NULL, X INT NOT NULL, Y INT NOT NULL, TRUCK_ID INT NOT NULL, USER_ID INT NOT NULL, ITEMS VARCHAR(200));";
