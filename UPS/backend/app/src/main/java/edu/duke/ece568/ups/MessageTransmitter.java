...
public class MessageTransmitter {
  /**
   * This function will "send" the data(should follow Google Protocol Buffer) to
   * corresponding output stream. You should handle the timeout by yourself.
   * 
  ...
  /**
   * This function will only "read" the data from corresponding input stream. You
   * should handle the sendToWorld back ask by yourself.
   * 
